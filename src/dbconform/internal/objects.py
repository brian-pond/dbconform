"""
Internal schema object definitions for diff and DDL generation.
...
class ColumnDef:
    """
    Internal schema column definition.

    data_type_name: neutral type name (e.g. 'INTEGER', 'VARCHAR(255)')
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return (
            ...
            and self.data_type_name == other.data_type_name
...
class TableDef:
    """
    Internal schema table definition for diff and DDL.
